...
#   SOFT_SAND    #8D847A
#   DEEP_TAUPE   #3A342E
IVORY       = (245, 241, 235)   # основной фон
WARM_WHITE  = (255, 252, 248)   # светлый верх градиента
BEIGE       = (216, 197, 177)   # акценты, кольцо аватара, разделители
SOFT_SAND   = (141, 132, 122)   # второстепенный текст, подписи
DEEP_TAUPE  = (58, 52, 46)      # основной текст

# Производные оттенки (мягкие, без контраста)
HAIRLINE    = (228, 219, 207)   # тонкие линии-разделители
SHADOW_RGBA = (58, 52, 46, 55)  # цвет мягкой тени (с альфой)
AVATAR_PLACEHOLDER_BG = (210, 196, 180)  # фон дефолтного аватара
